...
- [COSAI-Labs/toolpipe-mcp-server](https://github.com/COSAI-Labs/toolpipe-mcp-server) 📇 - 120+ developer utility tools (JSON formatting, code review, QR codes, hashing, regex, DNS, WHOIS, SSL checking, fake data, Docker Compose generation, and more) accessible via MCP. Zero install via remote URL or npx.

...
[![Subreddit subscribers](https://img.shields.io/reddit/subreddit-subscribers/modelcontextprotocol?style=flat&logo=reddit&label=subreddit)](https://www.reddit.com/r/modelcontextprotocol/)
...
* [r/modelcontextprotocol Reddit](https://www.reddit.com/r/modelcontextprotocol)
...
- [SandBase CLI](https://github.com/sandbaseai/cli) 📇 - Open-source CLI and MCP bridge exposing an OpenAI-compatible endpoint for 2,000+ AI models, with usage-based billing and a free plan
...
- [mcp-hub](https://github.com/jiale-cheng-ning/mcp-hub) 🦀 🏠 🍎 🪟 🐧 - TUI dashboard for managing, monitoring, and auditing MCP server configurations across Claude Desktop, Cursor, VS Code, and Windsurf. Auto-discovers configs, runs security audits (plaintext secrets, dangerous permissions, unpinned packages), and health checks.
